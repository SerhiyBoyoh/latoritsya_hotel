...
<head>
  ...
  <title><?php echo $settings_r['site_title'] ?> - Профіль</title>
</head>
<body class="bg-light">
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-12 my-5 px-4">
        <h2 class="fw-bold">ПРОФІЛЬ</h2>
        <div style="font-size: 14px;">
          <a href="index.php" class="text-secondary text-decoration-none">Головна</a>
          <span class="text-secondary"> > </span>
          <a href="#" class="text-secondary text-decoration-none">ПРОФІЛЬ</a>
        </div>
      </div>
      ...
      <div class="col-12 mb-5 px-4">
        <div class="bg-white p-3 p-md-4 rounded shadow-sm">
          <form id="info-form">
            <h5 class="mb-3 fw-bold">Основна інформація</h5>
            <div class="row">
            ...
            <button type="submit" class="btn text-white custom-bg shadow-none">Зберегти зміни</button>
          </form>
        </div>
      </div>
      ...
      <div class="col-md-4 mb-5 px-4">
        <div class="bg-white p-3 p-md-4 rounded shadow-sm">
          <form id="profile-form">
            <h5 class="mb-3 fw-bold">Зображення</h5>
      ...
      <div class="col-md-8 mb-5 px-4">
        <div class="bg-white p-3 p-md-4 rounded shadow-sm">
          <form id="pass-form">
            <h5 class="mb-3 fw-bold">Змінити пароль</h5>
            <div class="row">
  ...
  <script>
    ...
    profile_form.addEventListener('submit',function(e){
      ...
      xhr.onload = function()
      {
        if(this.responseText == 'inv_img'){
          ...
          alert('error',"Оновлення не вдалося!");
        }
        else{
    ...
    pass_form.addEventListener('submit',function(e){
      ...
      if(new_pass!=confirm_pass){
        alert('error','Пароль не збігається!');
        return false;
      }
