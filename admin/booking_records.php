...
<head>
  ...
  <title>Записи про бронювання</title>
  ...
  <div class="container-fluid" id="main-content">
    <div class="row">
      <div class="col-lg-10 ms-auto p-4 overflow-hidden">
        <h3 class="mb-4">ЗАПИСИ ПРО БРОНЮВАННЯ</h3>
              ...
              <table class="table table-hover border" style="min-width: 1200px;">
                <thead>
                  <tr class="bg-dark text-light">
                    <th scope="col">#</th>
                    <th scope="col">Інформація про користувача</th>
                    <th scope="col">Інформація про номер</th>
                    <th scope="col">Деталі бронювання</th>
