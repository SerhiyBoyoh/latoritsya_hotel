<?php 
  ...
  if(isset($_POST['get_bookings']))
  {
    ...
    if($total_rows==0){
      $output = json_encode(["table_data"=>"<b>Дані не знайдено!</b>", "pagination"=>'']);
      echo $output;
      exit;
    }
        ...
        <tr>
          ...
          <td>
            <span class='badge bg-primary'>
              Ідентифікатор замовлення: $data[order_id]
            </span>
            <br>
          ...
          <td>
            ...
            <br>
            <b>Price:</b> $data[price] грн
          </td>
          <td>
            <b>Amount:</b> $data[trans_amt] грн
            <br>
            <b>Date:</b> $date
          </td>
          <td>
