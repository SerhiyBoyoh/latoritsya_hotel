...
<head>
  ...
  <title>Рейтинги та відгуки</title>
  ...
  <div class="container-fluid" id="main-content">
    <div class="row">
      <div class="col-lg-10 ms-auto p-4 overflow-hidden">
        <h3 class="mb-4">РЕЙТИНГИ ТА ВІДГУКИ</h3>
          ...
          <div class="card-body">
            ...
            <div class="text-end mb-4">
              <a href="?seen=all" class="btn btn-dark rounded-pill shadow-none btn-sm">
                <i class="bi bi-check-all"></i> Позначити все прочитане
              </a>
              <a href="?del=all" class="btn btn-danger rounded-pill shadow-none btn-sm">
                <i class="bi bi-trash"></i> Видалити все
              </a>
            </div>
                ...
                <tbody>
                  <?php 
                    ...
                    while($row = mysqli_fetch_assoc($data))
                    {
                      ...
                      $seen.="<a href='?del=$row[sr_no]' class='btn btn-sm rounded-pill btn-danger'>Видалити</a>";
