...
<head>
  ...
  <title>Панель адміністратора - Інформаційна панель</title>
  ...
  <div class="container-fluid" id="main-content">
    <div class="row">
      <div class="col-lg-10 ms-auto p-4 overflow-hidden">
        ...
        <div class="d-flex align-items-center justify-content-between mb-4">
          ...
          <?php 
            if($is_shutdown['shutdown']){
              echo<<<data
                <h6 class="badge bg-danger py-2 px-3 rounded">Режим вимкнення активовано!</h6>
              data;
            }
          ?>
        </div>
        ...
        <div class="row mb-3">
          <div class="col-md-3 mb-4">
            <div class="card text-center text-primary p-3">
              <h6>Загальна кількість бронювань</h6>
        ...
        <div class="d-flex align-items-center justify-content-between mb-3">
          <h5>Аналітика користувачів, запитів, відгуків</h5>
